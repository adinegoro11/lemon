    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li <?php echo $link[1];?>><a href="<?php echo base_url();?>prtg/timika">Timika</a></li>
          <li <?php echo $link[2];?>><a href="<?php echo base_url();?>prtg/makassar">Makassar</a></li>
          <li><a href="<?php echo base_url();?>sensor/index/idr_ip">Sensor</a></li>
          <!--<li <?php echo $link[3];?>><a href="<?php echo base_url();?>prtg/batam">Batam</a></li>
