		...
		<div class="panel panel-primary">
			<div class="panel-heading"> <h3 class="panel-title">Ubah Sensor</h3> </div>
				<div class="panel-body"> 
					...
					<form class="form-horizontal" action="<?php echo base_url()."sensor/set/".$id; ?>"  method="post" accept-charset="utf-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
							<input type="number" class="form-control" name="id_sensor" value="<?php echo $id_sensor;?>" placeholder="ID Sensor" required="required" autocomplete="off"> 
