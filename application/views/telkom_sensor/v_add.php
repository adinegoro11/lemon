		...
		<div class="panel panel-primary">
			<div class="panel-heading"> <h3 class="panel-title">Tambah Sensor</h3> </div>
				<div class="panel-body"> 
					...
					<form class="form-horizontal" action="<?php echo base_url()."telkom_sensor/add"; ?>"  method="post" accept-charset="utf-8">

					<div class="form-group">
						<label for="nama_link" class="col-sm-2 control-label">Lokasi</label>
						<div class="col-sm-4"> 
							<input type="text" class="form-control" name="nama_link" placeholder="Nama Lokasi" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
							<input type="number" class="form-control" name="sensor_ping" placeholder="Sensor Ping" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
							<input type="number" class="form-control" name="sensor_uptime" placeholder="Sensor Uptime" required="required" autocomplete="off"> 
