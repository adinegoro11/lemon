		...
		<div class="panel panel-primary">
			<div class="panel-heading"> <h3 class="panel-title">Ubah Sensor</h3> </div>
				<div class="panel-body"> 
					...
					<form class="form-horizontal" action="<?php echo base_url()."sensor/set_idr_ip/".$id; ?>"  method="post" accept-charset="utf-8">

					<div class="form-group">
						<label for="nama_link" class="col-sm-2 control-label">Nama Link</label>
						<div class="col-sm-4"> 
						<input type="text" class="form-control" name="nama_link" id="nama_link" value="<?php echo $sql[0]->nama_link;?>" placeholder="Nama Lokasi" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
						<input type="number" class="form-control" name="sensor_tx_traffic" value="<?php echo $sql[0]->sensor_tx_traffic;?>"  placeholder="Sensor Tx" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
						<input type="text" class="form-control" name="sensor_rx_traffic" value="<?php echo $sql[0]->sensor_rx_traffic;?>" placeholder="Sensor Rx" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
						<input type="text" class="form-control" name="sensor_lebno" value="<?php echo $sql[0]->sensor_lebno;?>" placeholder="Sensor Local Ebno" required="required" autocomplete="off"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-4"> 
						<input type="text" class="form-control" name="sensor_rebno" value="<?php echo $sql[0]->sensor_rebno;?>" placeholder="Sensor Remote Ebno" required="required" autocomplete="off"> 
